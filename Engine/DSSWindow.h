static int (__thiscall *KalItemShop1)(void *a, const char *a2, int a3) = (int (__thiscall*)(void*,const char*,int))0x005D8D20; // 100%
static int (__thiscall *KalItemShop2)(void *a, const char *a2, int a3) = (int (__thiscall*)(void*,const char*,int))0x005D8E30; // 100%
static int (__thiscall *KalItemShop3)(void *a, const char *a2, int a3) = (int (__thiscall*)(void*,const char*,int))0x005DBB20;// 100%
static int (__stdcall *KalShop)(char a1) = (int (__stdcall*)(char))0x005DBA70; //100%
static int (__cdecl *ShopKal)() = (int (__cdecl*)())0x005D8580; //100%
