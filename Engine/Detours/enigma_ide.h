...
BOOL __declspec(dllimport) __stdcall EP_ActivationActivate();
BOOL __declspec(dllimport) __stdcall EP_ActivationActivateWithId(const char* ActivationId);
BOOL __declspec(dllimport) __stdcall EP_ActivationActivateWithIdA(const char* ActivationId);
BOOL __declspec(dllimport) __stdcall EP_ActivationActivateWithIdW(const wchar_t* ActivationId);
