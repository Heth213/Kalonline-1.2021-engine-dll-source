static signed int (__cdecl *IsPlayerCheck)() = (signed int (__cdecl*)())0x00705F90; // 100%
static signed int (__cdecl *IsPlayerAttack)() = (signed int (__cdecl*)())0x00702AA0; // KGameSys::CanAttack
static int (__thiscall *EndDashSkill)(int Player) = (int (__thiscall*)(int))0x00437A00; // 100%
static void *(__thiscall *SetTip)(int pTarget, LPCTSTR pString, COLORREF color, int dwLife, int bShowName) = (void *(__thiscall*)(int,LPCTSTR,COLORREF,int,int))0x00433F10; // 95%
static int (__thiscall *PlayerTick)(void *pTarget, unsigned int Value) = (int (__thiscall*)(void*,unsigned int))0x0041F100; // 98%
static signed int (__cdecl *SkillButton)(int Value) = (signed int (__cdecl*)(int))0x0042DE50; // CSkill::Reset 
